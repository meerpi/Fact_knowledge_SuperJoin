...
- **Demo Video Link:** [Google Drive Demo Video](https://drive.google.com/file/d/1G0tMmH70BHjjhN0yQnnQoJHa67q8sjD0/view?usp=sharing) 
...
| **Numeric Comparison** (does 21 equal 21?)                                        | **No**           | **Symbolic Math**: Cosine similarity says $50M and $80M revenue are 98% similar. Math must be deterministic: ` |
...
1. `01-delhivery-prospectus-2022-excerpt.pdf`, Page 49:
   ...
   - *Reported value:* `21`
1. `01-delhivery-prospectus-2022-excerpt.pdf`, Page 42:

   - *Verbatim quote:* `"We operated 21 fully and semi-automated sortation centres"`
   - *Reported value:* `21`
1. `03-delhivery-q4-fy24-earnings-presentation.pdf`, Page 7:
...
1. `02-delhivery-annual-report-fy24-excerpt.pdf`, Page 12 (Executive Highlights):
   ...
   - *Claimed value:* `4,445`
1. `02-delhivery-annual-report-fy24-excerpt.pdf`, Page 46 (Audited Operational Review):

   - *Verbatim quote:* `"3,506 delivery centres"` + *"partner centres: 85"*
   - *Summed value:* `3,591` ($3,506 + 85$)
1. `01-delhivery-prospectus-2022-excerpt.pdf`, Page 51 (Earlier baseline):
...
1. `02-delhivery-annual-report-fy24-excerpt.pdf`, Page 80 (Comparative Column):

   - *Reported value:* `₹15,238.07 Million`
   - *Context:* `As at March 31, 2023`
1. `01-delhivery-prospectus-2022-excerpt.pdf`, Page 24:
...
1. **Lack of UI polish & responsiveness.** Due to time constraints, the frontend has rough edges. It isn't fully mobile-responsive, some complex tables could look cleaner, and transitions between views could be smoother. We prioritized getting the core pipeline, bounding-box exhibits, and cross-document reconciliation rock-solid over styling perfection.
1. **The demo video is rushed.** Fitting a PDF ingestion walkthrough, the pipeline architecture, and all four complex financial cases into a strict 3-minute limit meant talking fast and cutting corners on deep commentary. 
1. **Edge cases in table nesting.** While Docling handles standard financial layouts well, heavily nested footnotes or borderless multi-column splits can still misalign about 5% of cells.
1. **No human-in-the-loop audit interface yet.** Classification currently runs completely algorithmically. In a real-world setting, compliance analysts would need a screen to manually override or confirm disputed edges.
